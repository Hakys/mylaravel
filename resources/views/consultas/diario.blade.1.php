...
@section('style')
    ...
    <!-- {!! asset('theme_admin/vendor/calendario-bs/') !!} -->
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
            <table id="consultaTable" class="table table-bordered table-hover" >
                <thead>
                ...
                <tbody>
                    @foreach($consultas as $consulta)
                        <tr class="item{{$consulta->id}} @if($consulta->asistio) alert-info @else alert-success @endif" >                             
                            <td>{{ $consulta->fecha->format('H:i') }}</td>  
                            <td>@if($consulta->cliente)
                                <button type="button" class="btn btn-default" data-toggle="tooltip"
                                    data-placement="left" title="{{$consulta->comentario}}"> {{ $consulta->cliente->full_name }} </button>
                                     <a href="{{ route('clientes.show', $consulta->cliente) }}"><span class="fa fa-lg fa-info-circle"></span> Ver Ficha </a>
                                </button>
                                @else
                                    <a href="#">Reservar</a> <a href="#">Pasar Consulta</a>
                                @endif
                            </td>
