        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto ml-auto text-right">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ url('/contact') }}">Info. de Contacto</a></li>
                    @guest
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @guest
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('login') }}">{{ __('Área Privada') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('register') }}">{{ __('Registrarse') }}</a>
                        </li>
                    @else 
                        <li class="nav-item"><a class="nav-link" href="{{ route('home') }}">Área Privada</a></li>
